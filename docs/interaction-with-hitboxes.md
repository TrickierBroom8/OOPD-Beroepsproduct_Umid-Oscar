...
`com.github.hanyaeger.beroepsproduct.entities.swordfish`. In this package create a
...
`com.github.hanyaeger.beroepsproduct.entities.swordfish` in the following way:
